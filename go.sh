...
caliper benchmark run --caliper-benchconfig benchmarks/api/fabric/couchDB/empty-contract-2of.yaml  --caliper-networkconfig networks/fabric/fabric-v1.4.1/2org1peercouchdb/api/fabric-api-java-prometheus.yaml --caliper-workspace . --caliper-fabric-usegateway
